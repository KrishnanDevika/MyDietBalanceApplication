...
public class CustomViewPagerAdapter extends FragmentStateAdapter {
    ...
    public Fragment createFragment(int position) {
        ...
        switch (position){
            case 0:
                return HealthyTipsFragment.newInstance("Drink Lots of Water", " \t\t\t\tDrinking enough water throughout the day is good for overall health and can even help you maintain a healthy weight. Drink a glass of water before you dive into a snack. People sometimes confuse thirst with hunger, so you can end up eating extra calories when an ice-cold glass of water is really all you needed. ");

            case 1:
                return HealthyTipsFragment.newInstance("Eat fruits and Vegetables everyday", "\t\t\t\tPick out a new fruit or vegetable in the grocery store each week, and figure out together how to cook or prepare it in a healthy way. Vegetables are loaded with fiber and the nutrients your body craves.");

            case 2:
                return HealthyTipsFragment.newInstance("Never Skip Breakfast", "\t\t\t\tBreakfast is the most important meal of the day! Opt for something that will release energy slowly — porridge and a handful of blueberries are a great option!. Not eating breakfast can make you hungry later, leading to too much nibbling and binge eating at lunch and dinner.");
